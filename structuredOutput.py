...
class review(TypedDict):
    name: Annotated[str, "the name of product"]
    details: Annotated[str, "write a short details about the product, if available"]
    keyfeatures: Annotated[list[str], "a list of key features of product, if available"]    
